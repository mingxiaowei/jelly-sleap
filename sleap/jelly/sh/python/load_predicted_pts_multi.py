...
multi_4k_tracked_points = get_all_untracked_points(multi_4k_dataset, reorder=True, interpolate=False, min_score=0.5, start_idx=0, use_labeled_only=False)
multi_4k_points_path = '/home/mingxiao/Desktop/jellyfish/label/multifish/predictions/multifish_animal_1_v11_predicted_points.npy'
