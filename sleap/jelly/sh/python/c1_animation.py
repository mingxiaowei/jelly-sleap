...
c1_pp_thres45_poly_corrected_path = os.path.join(pp_dir, 'c1_raw_pts_pp_thres45_v2.npy')
c1_pp3_thres45_poly_corrected_path = os.path.join(pp_dir, 'c1_raw_pts_pp3_thres45_v2.npy')
...
anim_label_lst = ['raw', 'avg flow (thres=45)', 'polar (thres=45)']
anim_path = '/home/mingxiao/Desktop/animation/c1_pp_v3.mp4'
