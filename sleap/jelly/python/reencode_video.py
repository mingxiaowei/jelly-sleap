...
def reencode_video(input_file: str, output_file: str, ss_str:str=None) -> None:
    ...
    ffmpeg_cmd = f'ffmpeg -y -i {input_file} -ss {ss_str} -t 20 -c:v libx264 -pix_fmt yuv420p -preset superfast -crf 0 {output_file}'
...
if __name__ == "__main__":
    ...
    INPUT_FILE = '/home/mingxiao/Desktop/jellyfish/video/video_1_clips/animal_1_1h_1min.mp4'
    OUTPUT_FILE = f'/home/mingxiao/Desktop/jellyfish/video/video_1_clips/animal_1_1h_20s.mp4'
